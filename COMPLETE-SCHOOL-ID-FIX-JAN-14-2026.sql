-- =====================================================
-- COMPLETE SCHOOL_ID FIX - Includes ALL policies
-- Date: January 14, 2026
-- Based on Supabase Assistant feedback
-- =====================================================

-- Step 1: Drop ALL policies (including the missing one)
...
-- Step 5: Change column type (THE FIX)
...
-- Note: You need to provide the original USING expression for this policy
-- Run this diagnostic query first to get the exact definition:
-- SELECT pg_get_policydef(oid) FROM pg_policy WHERE polname = 'school_isolation_assessments' AND polrelid = 'student_assessments'::regclass;

-- Step 10: Recreate other policies
