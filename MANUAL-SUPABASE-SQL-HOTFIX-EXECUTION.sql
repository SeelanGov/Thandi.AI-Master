-- =====================================================
-- PRODUCTION HOTFIX: Manual SQL Execution Script
...
-- Step 1: Create backup of original function
...
-- Step 2: Deploy the FIXED function with ambiguity resolution
...
-- Step 3: Update RLS policies with explicit table aliases
...
-- =====================================================
-- VERIFICATION: Test the fix (OPTIONAL - for verification only)
-- =====================================================
-- Uncomment the lines below to test the function after deployment
-- Replace 'TEST_SCHOOL_ID' with an actual school ID from your database

/*
SELECT create_student_school_association(
  'Production',
  'HotfixTest', 
  'TEST_SCHOOL_ID',  -- Replace with actual school ID
  11,
  true,
