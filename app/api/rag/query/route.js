...
export async function POST(request) {
  ...
  try {
    ...
    // PHASE 2: Check Upstash Redis cache FIRST (before consent check for speed)
    ...
    // PHASE 2: Cache the response in Upstash Redis (background, non-blocking)
...
export async function GET() {
  ...
  // PHASE 2: Include Upstash Redis cache stats
